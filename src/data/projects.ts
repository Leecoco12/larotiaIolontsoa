...
export const projectData: Project[] = [
  ...
  // },
  {
    ...
    category: 'residential',
    excerpt: 'Conception 2D d\'une maison moderne à Ambatondrazaka, intégrant des principes de durabilité et d\'évolutivité.',
    description: 'Ce projet de maison individuelle de 150m² a été conçu pour répondre aux besoins d\'une famille moderne tout en intégrant des principes de durabilité et d\'évolutivité. Le plan 2D présente une organisation fonctionnelle des espaces, avec un grand séjour ouvert sur la cuisine, chambres, salles de bains et un bureau. La maison est orientée pour maximiser l\'apport de lumière naturelle et minimiser les besoins en chauffage.',
    challenge: 'Créer un plan qui puisse évoluer avec les besoins de la famille, tout en respectant les contraintes de budget et de terrain. Le projet devait également intégrer des solutions écologiques pour réduire l\'empreinte carbone.',
    solution: 'Le plan a été conçu avec des espaces modulables, permettant d\'ajouter ou de modifier des pièces à l\'avenir. Des matériaux locaux et durables ont été privilégiés pour la construction. L\'orientation du bâtiment et l\'utilisation de brise-soleil permettent de réguler naturellement la température intérieure, réduisant ainsi les besoins en climatisation.',
    mainImage: plan,
    images: [
      plan1,
      plan2,
